...
N 1420 -1140 1420 -1040 {lab=DOUT}
N 1340 -1170 1380 -1170 {lab=BLB}
N 1340 -1170 1340 -1010 {lab=BLB}
N 1340 -1010 1380 -1010 {lab=BLB}
N 1420 -1080 1520 -1080 {lab=DOUT}
N 1260 -1080 1340 -1080 {lab=BLB}
N 1420 -1260 1420 -1200 {lab=VDD}
N 1420 -980 1420 -920 {lab=0}
N 1420 -1170 1480 -1170 {lab=VDD}
N 1480 -1220 1480 -1170 {lab=VDD}
N 1420 -1220 1480 -1220 {lab=VDD}
N 1420 -1010 1480 -1010 {lab=0}
N 1480 -1010 1480 -960 {lab=0}
N 1420 -960 1480 -960 {lab=0}
...
.meas tran t_wl   WHEN v(wl)=2.5 RISE=2
.meas tran t_dout WHEN v(dout)=2.5 RISE=1 TD=24n
.meas tran t_read PARAM='t_dout-t_wl'
"}
...
C {TR-1umLIB/MP.sym} 1380 -1170 0 0 {name=XM9
model=PMOS
w=6.8u
l=1u
m=1
...
nrd=0
nrs=0}
C {devices/gnd.sym} 1420 -920 0 0 {name=l12 lab=0}
C {devices/lab_pin.sym} 1260 -1080 0 0 {name=p35 sig_type=std_logic lab=BLB}
C {devices/lab_pin.sym} 1420 -1260 0 0 {name=p37 sig_type=std_logic lab=VDD}
C {devices/opin.sym} 1520 -1080 0 0 {name=p36 lab=DOUT}
C {TR-1umLIB/MN.sym} 1380 -1010 0 0 {name=XM8
model=NMOS
w=3.4u
l=1u
m=1
